...
pub struct SmoltcpStorage<'a, const I: usize, const O: usize, const N: usize> {
    ...
    jack_rx_metadata_buffers: [[UdpPacketMetadata; 4]; I],
    jack_rx_payload_buffers: [[u8; 2048]; I],
...
impl<const I: usize, const O: usize, const N: usize> Default for SmoltcpStorage<'_, I, O, N> {
    fn default() -> Self {
        SmoltcpStorage {
            ...
            jack_rx_metadata_buffers: [[UdpPacketMetadata::EMPTY; 4]; I],
            jack_rx_payload_buffers: [[0; 2048]; I],
